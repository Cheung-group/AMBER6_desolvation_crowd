...
#include "lgcom.h"
#include "avfrc.h"
c Margaret Langevin and douwell potential
#include "LAN.h"
#include "douwell.h"  
c end of Margaret
#ifdef MPI
...
C
  220 CONTINUE
      ...
      NRU = NRU+1
C
c start Margaret for double well.
...
c start Margaret for langevin.
	...
	RRADIUS = 3
c       water visco = 0.1439 kcal*ps/mol*(AA**3) * 20.445 
        WVISCO = 0.1439 * 20.445 
	eta= 6*PI*RRADIUS*WVISCO   
        BOLTZ = 1.9872d-3        
c        write(75,*)eta    
c        close(75)
